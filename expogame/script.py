# Przygotowanie danych do gry quiz
import json

# Dane pytań i odpowiedzi na podstawie zebranych informacji o kolekcjach
quiz_data = {
    "questions": [
        {
            "id": 1,
...
print("Dane do gry quiz zostały przygotowane!")
print(f"Liczba pytań: {len(quiz_data['questions'])}")
print(f"Liczba kolekcji: {len(quiz_data['collections'])}")

# Zapisanie danych do pliku JSON
with open('quiz_data.json', 'w', encoding='utf-8') as f:
    json.dump(quiz_data, f, ensure_ascii=False, indent=2)

print("Dane zapisane do pliku quiz_data.json")